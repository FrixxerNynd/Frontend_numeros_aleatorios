...
const API = process.env.NEXT_PUBLIC_GAMES_API_URL || 'http://localhost:3001';
...
export default function RoulettePage() {
  const { userId, balance, fetchBalance } = useWalletStore();
  ...
  const handleSpin = async () => {
    ...
    try {
      ...
      setSpinError(error.message || 'Error al conectar con el servidor');
      setIsSpinning(false);
    }
  };
      ...
      <div className="flex flex-col lg:flex-row gap-12 items-start justify-center">
          ...
          <div className="w-full bg-white/5 rounded-3xl p-6 border border-white/5 backdrop-blur-md">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex-[2] h-12 bg-red-600 hover:bg-red-500 rounded-xl flex items-center justify-center gap-2 text-white font-bold transition-all shadow-lg shadow-red-600/20 disabled:opacity-20 translate-y-0 active:translate-y-1"
              >
        ...
        <div className="lg:w-2/3 flex flex-col gap-8">
          <div className="flex justify-between items-end">
             <div>
                <h1 className="text-5xl font-black tracking-tighter uppercase italic">Ruleta <span className="text-red-500">Original</span></h1>
                <p className="text-white/40 font-light mt-2 max-w-md">La misma experiencia que conoces, ahora integrada en el puerto unificado.</p>
             </div>
